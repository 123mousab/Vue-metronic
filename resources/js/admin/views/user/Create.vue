            ...
            <div class="m-portlet m-portlet--tab">
                ...
                <form class="m-form m-form--fit m-form--label-align-right">
                    <div class="m-portlet__body">
                        <div class="form-group m-form__group">
                            <label for="exampleInputEmail1">Email address</label>
                            <input type="email" class="form-control m-input m-input--square" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Enter email">
                            <span class="m-form__help">We'll never share your email with anyone else.</span>
                        </div>
                        <div class="form-group m-form__group">
                            <label for="exampleInputPassword1">Password</label>
            ...
            <div class="m-portlet m-portlet--tab">
                ...
                <form class="m-form m-form--fit m-form--label-align-right">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            <label for="exampleInputPassword1">Password</label>
                            <input type="password" class="form-control m-input m-input--solid" id="exampleInputPassword1" placeholder="Password">
                        </div>
                        <div class="form-group m-form__group">
                            <label>Disabled</label>
                            <input type="password" class="form-control m-input m-input--solid" disabled="" placeholder="Disabled">
                        </div>
                        <div class="form-group m-form__group">
                            <label for="exampleSelect1">Example select</label>
                ...
                <form class="m-form m-form--fit m-form--label-align-right">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="email" class="form-control m-input" disabled="disabled" placeholder="Disabled input">
                        </div>
                        <div class="form-group m-form__group">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="email" class="form-control m-input" readonly="" placeholder="Readonly input">
                        </div>
                        <div class="form-group m-form__group">
                ...
                <form class="m-form m-form--fit m-form--label-align-right">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group m-form__group">
                            ...
                            <input type="email" class="form-control form-control-lg m-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Large input">
                        </div>
                        <div class="form-group m-form__group">
                            <label for="exampleInputEmail1">Default Input</label>
                            <input type="email" class="form-control m-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Large input">
                        </div>
                        <div class="form-group m-form__group">
                            <label for="exampleInputEmail1">Small Input</label>
                            <input type="email" class="form-control form-control-sm m-input" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Large input">
                        </div>
                        <div class="form-group m-form__group">
                            <label for="exampleSelect1">Large Select</label>
                        ...
                        <div class="form-group m-form__group">
                            <label for="exampleSelect1">Default Select</label>
                            <select class="form-control m-input" id="exampleSelect1">
                                <option>1</option>
                                <option>2</option>
                                <option>3</option>
                        ...
                        <div class="form-group m-form__group">
                            <label for="exampleSelect1">Small Select</label>
                ...
                <form class="m-form m-form--fit m-form--label-align-right">
                    <div class="m-portlet__body">
                        ...
                        <div class="form-group1 m-form__group">
                            <label for="exampleInputEmail1">Custom Select</label>
                            <div></div>
